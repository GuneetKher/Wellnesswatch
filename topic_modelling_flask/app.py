...
url_lda = 'https://storage.googleapis.com/topic_modelling_bucket/lda.pickle'

# Load the contents of the URL into a bytes object
with urlopen(url_lda) as f:
    lda_pickle_bytes = f.read()

# Load the bytes into a Python object using pickle
lda_model = pickle.loads(lda_pickle_bytes)


# URL of the pickle file in Google Cloud Storage
url_tfidf = 'https://storage.googleapis.com/topic_modelling_bucket/tfidf_data.pickle'

# Load the contents of the URL into a bytes object
with urlopen(url_tfidf) as f:
    tfidf_pickle_bytes = f.read()

# Load the bytes into a Python object using pickle
vectorizer, term_matrix, feature_names = pickle.loads(tfidf_pickle_bytes)
